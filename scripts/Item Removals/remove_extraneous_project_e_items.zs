...
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star:5>);
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star:4>);
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star:3>);
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star:2>);
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star:1>);
mods.jei.JEI.removeAndHide(<projecte:item.pe_klein_star>);